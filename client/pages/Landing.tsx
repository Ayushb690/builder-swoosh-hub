...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-muted/20">
      <Topbar title="FRA+Ai" showTitle={false} showLogo={false} showSearch={false} showProfile={false} showMenu={false} />
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center py-16">
          <div className="text-center">
            ...
            <h1 className="mt-6 text-4xl sm:text-5xl font-extrabold tracking-tight">FRA+Ai</h1>
            <p className="mt-3 text-lg text-muted-foreground">simple and Futuristic</p>
            <button
