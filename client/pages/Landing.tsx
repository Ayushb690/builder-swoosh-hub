      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center py-16">
          <div className="text-center">
            <div className="mx-auto h-16 w-16 grid place-items-center rounded-lg bg-primary text-primary-foreground font-bold shadow-sm">FA</div>
            <h1 className="mt-6 text-4xl sm:text-5xl font-extrabold tracking-tight">FRA Atlas</h1>
            <p className="mt-3 text-lg text-muted-foreground">Digitizing Forest Rights for Empowered Communities</p>
            <button
